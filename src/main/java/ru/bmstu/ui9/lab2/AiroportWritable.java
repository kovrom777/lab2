...
public class AiroportWritable implements Writable {
    ...
    public IntWritable getAirline_ID() {
        return airline_ID;
    }
    ...
    public IntWritable getOrigin_airport_seq_id() {
        return origin_airport_seq_id;
    }

    public IntWritable getOrigin_city_market_id() {
    ...
    public IntWritable getWheels_on() {
        return wheels_on;
    }

    public IntWritable getArr_time() {
        return arr_time;
    }
    ...
    public DoubleWritable getCanceled() {
        return canceled;
    }
    ...
    public Text getCancelation_code() {
        return cancelation_code;
    }
